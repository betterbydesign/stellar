...
export default async function PlatformPage() {
  ...
  if (config.mode !== "ready") return <main className="shell">
    ...
    <section className="intro">
      <p className="eyebrow">Your account</p><h1>Connect your account services.</h1>
  ...
  return <main className="shell">
    <header className="masthead"><span className="wordmark">Stellar<span aria-hidden="true">✳</span></span>
      {session ? <form action={signOutAction}><button type="submit">Sign out</button></form> : <span className="status">Your account</span>}
    </header>
    <section className="intro"><p className="eyebrow">Independent by design</p><h1>Your websites.</h1>
