...
| D13 | Product and IP boundary | User intends personal-GitHub development and licensing Stellar to the company. Confirm the owning person/entity, employment/jurisdiction and written company arrangement, Agent Hub/harness reuse rights and separate development/runtime accounts. Proposed: reusable modules with a separately usable Stellar app. [Bootstrap plan](BOOTSTRAP-PLAN.md) defines the next preparation slices. |
